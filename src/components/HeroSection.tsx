  ...
  return (
    <div className="text-center space-y-8 mb-16 animate-fade-in">
      ...
      <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto myanmar-text leading-relaxed">
       AI နည်းပညာအကူအညီဖြင့် မြန်မာဆိုရှယ်မီဒီယာပိုစ့်တွေရေးဖို့ လက်ထောက်လေးတစ်ယောက်လို အကူအညီပေးနိုင်အောင် ဖန်တီးတည်ဆောက်ထားသည်။ 
       မြန်မာယဉ်ကျေးမှုနှင့် ကိုက်ညီတဲ့ ပိုစ့်တွေကို အကန့်အသတ်မရှိ ရေးသားနိုင်သူလေးဖြစ်ပါတယ်။
      </p>
