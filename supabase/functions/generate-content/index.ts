...
function getPronounGuidelines(brandGender?: string): string {
  ...
  const pronounGuides = {
    male: `
### ယောက်ျား လိင်သေအိပ် အတွက် စကားလုံးရွေးချယ်မှု:
...
`,
    female: `
### မိန်းမ လိင်သေအိပ် အတွက် စကားလုံးရွေးချယ်မှု:
...
`,
    neutral: `
### ကြားခံ လိင်သေအိပ် အတွက် စကားလုံးရွေးချယ်မှု:
...
function getAdvancedBurmeseGuidelines(fbAnalysis?: FacebookAnalysis, brandGender?: string): string {
  let baseGuidelines = `
...
${getPronounGuidelines(brandGender)}
...
function buildContentPrompt(body: RequestBody, fbAnalysis?: FacebookAnalysis): string {
  const guidelines = getAdvancedBurmeseGuidelines(fbAnalysis, body.brandGender);
...
**ဘရန်း လိင်သေအိပ်**: ${body.brandGender ? 
  (body.brandGender === 'male' ? 'ယောက်ျား (ကျွန်တော်၊ သူ အသုံးပြုရန်)' : 
   body.brandGender === 'female' ? 'မိန်းမ (ကျွန်မ၊ သူမ အသုံးပြုရန်)' : 
   'ကြားခံ (ကျွန်ုပ်၊ လုပ်ငန်း အသုံးပြုရန်)') : 'သတ်မှတ်မထားပါ'}
...
${body.brandGender ? '7. သတ်မှတ်ထားသော ဘရန်း လိင်သေအိပ်အတွက် သင့်လျော်သော စကားလုံးများ အသုံးပြုပါ' : ''}
${fbAnalysis && Object.keys(fbAnalysis).length > 0 ? '8. Facebook Page ခွဲခြမ်းစိတ်ဖြာမှုအခြေခံ လမ်းညွှန်ချက်များကို လိုက်နာပါ' : ''}
